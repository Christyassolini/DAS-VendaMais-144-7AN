...
from triggers.extract_cliente2 import app as extract_cliente2
from triggers.extract_pedido import app as extract_pedido
from triggers.extract_entrega import app as extract_entrega
from triggers.extract_entrega2 import app as extract_entrega2
...
from triggers.extract_estoque_movimento import app as extract_estoque_movimento
...
app.register_functions(extract_entrega2)
...
app.register_functions(extract_estoque_movimento)
